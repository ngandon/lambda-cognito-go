...
func handleStop(ctx context.Context, request events.APIGatewayProxyRequest) (events.APIGatewayProxyResponse, error) {
	...
	if err != nil {
		return events.APIGatewayProxyResponse{
			Body:       "Error while stopping the instance",
			StatusCode: 500,
		}, nil
	}
	...
	return events.APIGatewayProxyResponse{
		StatusCode: 200,
		Body:       "{\"message\":\"Stopping instances\"}",
